namespace EasyFast.EntityFramework.Migrations
{
    ...
    public partial class Init : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.AbpOrganizationUnits", "Manager", c => c.String(maxLength: 50));
            AddColumn("dbo.AbpOrganizationUnits", "Tel", c => c.String(maxLength: 50));
            AddColumn("dbo.AbpOrganizationUnits", "Area", c => c.String(maxLength: 50));
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.AbpOrganizationUnits", "Area");
            DropColumn("dbo.AbpOrganizationUnits", "Tel");
            DropColumn("dbo.AbpOrganizationUnits", "Manager");
            AlterTableAnnotations(
                "dbo.AbpOrganizationUnits",
                c => new
                    {
