...
using EasyFast.Web.Controllers.Results;
using EasyFast.Web.Models.Account;
...
{
    public class AccountController : EasyFastControllerBase
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = Core.Entities.User.CreateRandomPassword();
